...
import com.assignment.service.ServiceImpl;
...
public class EmployeeController {
	...
	@RequestMapping(value="/employee/zip/{zip}")
	...
	@RequestMapping(value="/employee/city/{city}")
	...
	@RequestMapping(value="/new-employee", method=RequestMethod.POST, headers= {"content-type=application/json"})
	public ResponseEntity<Employee> addEmployee(@RequestBody Employee employee) {
		service.addEmployee(employee);
		return new ResponseEntity<Employee>(employee,HttpStatus.CREATED);
	}
	
	@RequestMapping(value="/drop-employee/id/{id}")
